...
export class CountriesService {
  ...
  getCountries(): Observable<Country[]> {
    return this.httpClient.get<Country[]>(this.urlPrefix + '/api/countries', {
      responseType: 'json',
    });
  }
  ...
  getCountryByCountryID(CountryID: number): Observable<Country> {
    return this.httpClient.get<Country>(
      this.urlPrefix + '/api/countries/searchbycountryid/' + CountryID,
      { responseType: 'json' }
    );
  }
  ...
  deleteCountry(CountryID: number | null): Observable<string> {
    return this.httpClient.delete<string>(
      this.urlPrefix + '/api/countries?countryID=' + CountryID
    );
  }
}
